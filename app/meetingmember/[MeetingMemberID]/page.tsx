import { meetingmember } from "@/app/generated/prisma/browser";
    ...
    <div className="flex justify-center mt-10">
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-8 w-full">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 border-b pb-4">Member Details</h1>

          <div className="space-y-4">
            <div className="flex justify-between">
              <span className="font-semibold text-gray-600 dark:text-gray-300">Member ID:</span>
              <span className="text-gray-900 dark:text-white">{data?.MeetingMemberID}</span>
            </div>
            <div className="flex justify-between">
              <span className="font-semibold text-gray-600 dark:text-gray-300">Meeting ID:</span>
              <span className="text-gray-900 dark:text-white">{data?.MeetingID}</span>
            </div>
            <div className="flex justify-between">
              <span className="font-semibold text-gray-600 dark:text-gray-300">Staff ID:</span>
              <span className="text-gray-900 dark:text-white">{data?.StaffID}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              <span className="font-semibold text-gray-600 dark:text-gray-300">Is Present:</span>
              <span className={`font-medium ${data?.IsPresent ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
